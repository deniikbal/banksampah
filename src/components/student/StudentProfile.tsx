      ...
      <div className="bg-gradient-to-br from-emerald-500 via-teal-500 to-green-600 rounded-2xl p-6 text-white shadow-lg">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-emerald-100 text-sm">Kelas: {student.class}</p>
          </div>
          <div className="text-right">
            <p className="text-emerald-100 text-xs font-medium">Trashbag Tersedia</p>
            <p className="text-3xl font-bold">
              {totalTrashbags} <span className="text-lg font-normal">trashbag</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-5 border border-blue-100">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-semibold text-gray-900">Total Botol</h3>
          </div>
          <p className="text-2xl font-bold text-blue-600">{totalBottles.toLocaleString('id-ID')}</p>
          <p className="text-sm text-gray-600 mt-1">Botol yang dikumpulkan</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-5 border border-purple-100">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-semibold text-gray-900">Total Trashbag</h3>
          </div>
          <p className="text-2xl font-bold text-purple-600">{earnedTrashbags}</p>
          <p className="text-sm text-gray-600 mt-1">Reward yang didapatkan</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-5 border border-amber-100">
          ...
          <p className="text-sm text-gray-600 mt-1">Badge lingkungan</p>
        </div>
      </div>
        ...
        {transactions.length === 0 ? (
          ...
          <div className="space-y-2">
            {transactions.slice(0, 5).map((transaction) => {
              ...
              return (
                <div key={transaction.id} className="flex justify-between items-center bg-gradient-to-r from-white to-gray-50 p-4 rounded-xl border border-gray-100 hover:shadow-md transition-all duration-200">
                  <div>
