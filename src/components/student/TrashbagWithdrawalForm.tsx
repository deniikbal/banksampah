  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 p-6">
      <div className="text-center">
        <div className="bg-gradient-to-r from-emerald-100 to-teal-100 p-4 rounded-full w-20 h-20 mx-auto mb-4 shadow-lg">
          <ShoppingBag className="w-12 h-12 text-emerald-600" />
        </div>
        <h2 className="text-2xl font-bold bg-gradient-to-r from-emerald-700 to-teal-700 bg-clip-text text-transparent mb-2">Penarikan Trashbag</h2>
        <p className="text-gray-600">Ajukan penarikan trashbag reward yang telah Anda kumpulkan</p>
      </div>

      {/* Available Trashbags Info */}
      <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl p-6 mb-6 border border-emerald-200 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <Gift className="w-6 h-6 text-emerald-600" />
            <div>
              <p className="text-sm text-emerald-700">Trashbag Tersedia</p>
              <p className="text-3xl font-bold text-emerald-800">{availableTrashbags}</p>
              <p className="text-xs text-emerald-600 mt-1">Maksimal penarikan</p>
            </div>
          </div>
          <div className="text-right">
            <p className="text-sm text-teal-700">Total Botol</p>
            <p className="text-xl font-bold text-teal-800">{totalBottles.toLocaleString('id-ID')}</p>
      ...
      {/* Reward Benefits */}
      <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4 mb-6 border border-emerald-200 shadow-sm">
        <div className="flex items-start gap-3">
          <CheckCircle className="w-5 h-5 text-emerald-600 mt-0.5" />
          <div>
            <h3 className="font-semibold text-emerald-800 mb-2">Keuntungan Trashbag:</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:border-transparent transition-colors shadow-sm ${
              validationError
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent shadow-sm"
            required
          />
        </div>
      ...
      {availableTrashbags <= 0 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-yellow-800 font-medium">Belum Ada Trashbag</p>
      ...
      <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg p-4 border border-emerald-200 shadow-sm">
        <h4 className="font-medium text-emerald-800 mb-2">Informasi Penting:</h4>
        <ul className="text-sm text-emerald-700 space-y-1">
