    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Bank Sampah</h1>
                <p className="text-sm text-emerald-100">Portal Siswa</p>
              </div>
            </div>
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="p-2 rounded-md text-white hover:text-emerald-100 hover:bg-white/10 focus:outline-none transition-all duration-200"
              >
          ...
          {/* Mobile Menu */}
          {isMobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-emerald-500/30 bg-white/10 backdrop-blur-sm">
              <button
                onClick={() => {
                  logout();
                  setIsMobileMenuOpen(false);
                }}
                className="flex items-center gap-2 w-full px-4 py-2 text-white hover:text-emerald-100 hover:bg-white/10 rounded-lg transition-all duration-200"
              >
                <LogOut className="w-4 h-4" />
                Keluar
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-sm">
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      key={tab.id}
                      onClick={() => setActiveTab(tab.id)}
                      className={`flex flex-col items-center justify-center min-w-[80px] py-3 px-2 font-medium text-xs transition-all duration-200 ${
                        activeTab === tab.id
          ...
          <div className="p-4 sm:p-6 bg-white/80 backdrop-blur-sm rounded-t-3xl shadow-lg min-h-[calc(100vh-8rem)]">
            {activeTab === 'profile' && (
              <StudentProfile
