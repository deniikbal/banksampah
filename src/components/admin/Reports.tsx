...
export function Reports() {
  ...
  const loadReportData = async () => {
    try {
      ...
      const totalTrashbags = transactions?.reduce((sum, t) => sum + (t.trashbag_reward || 0), 0) || 0;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
          <h3 className="text-xs text-gray-600 mb-1">Total Trashbag Reward</h3>
          <p className="text-xl font-bold text-blue-600">
            {reportData?.summary.totalTrashbags || 0} trashbag
          </p>
        </div>
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
          <h3 className="text-xs text-gray-600 mb-1">Total Siswa</h3>
          <p className="text-xl font-bold text-purple-600">
            {reportData?.summary.studentCount || 0} siswa
          </p>
        </div>
      </div>
